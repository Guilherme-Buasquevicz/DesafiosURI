...
public class UriOnze {
    public static void main(String[] args)throws IOException {

        Scanner sc = new Scanner(System.in);

        System.out.println("Qual a distancia que foi percorrida ?");
        double X = sc.nextDouble();

        System.out.println("Quantos litros de combustiveis você gastou ?");
        double Y = sc.nextDouble();

        double A = X / Y;

        System.out.println(String.format("%.3f km/l", A));
    }
}
